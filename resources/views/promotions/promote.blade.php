            ...
            <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
                <div class="row pt-2">
                    <div class="col ps-4">
                        ...
                        <p class="text-danger">
                            <small><i class="bi bi-exclamation-diamond-fill me-2"></i> Students must be promoted only once to
                                a new Session. Ususally, Admin will create a New Session once Academic activity ends for the
                        ...
                        <div class="mb-4 mt-4">
                            <form action="https://sim-academy.vercel.app/promotions/promote" method="POST">
                                        ...
                                        @isset($students)
                                            @foreach ($students as $index => $student)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-select form-select-sm" aria-label="Section"
                                ...
                                <button type="submit" class="btn btn-outline-primary mb-3"><i
                                        class="bi bi-sort-numeric-up-alt"></i> Promote</button>
                            </form>
                        </div>
                    </div>
                </div>
