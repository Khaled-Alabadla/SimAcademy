                                                ...
                                                <ul class="nav nav-tabs card-header-tabs">
                                                    ...
                                                    <li class="nav-item">
                                                        <button class="nav-link" data-bs-toggle="tab"
                                                            ...
                                                            role="tab" aria-current="false"><i
                                                                class="bi bi-journal-medical"></i> Courses</button>
                                                    </li>
                                                </ul>
                                            </div>
                                                                            ...
                                                                            <div id="accordionClass{{ $school_class->id }}Section{{ $school_section->id }}"
                                                                                ...
                                                                                <div class="accordion-body">
                                                                                    ...
                                                                                    <div class="list-group">
                                                                                        ...
                                                                                        <a href="{{ route('routine.list', ['class_id' => $school_class->id, 'section_id' => $school_section->id]) }}"
                                                                                            class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                                                                            View Routine
                                                                                        </a>
                                                                                    </div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="btn-group" role="group">
                                                                                    <a href="{{ asset($syllabus->syllabus_file_path) }}"
                                                                                        role="button"
                                                                                        class="btn btn-sm btn-outline-primary"><i
