                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (isset($student->student->photo))
                                                        <img src="{{ asset($student->student->photo) }}" class="rounded"
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="{{ route('student.attendance', ['id' => $student->student->id]) }}"
                                                            role="button" class="btn btn-sm btn-outline-primary"><i
                                                                class="bi bi-eye"></i> Attendance</a>
                                                        <a href="{{ route('student.profile', ['id' => $student->student->id]) }}"
                                                            role="button" class="btn btn-sm btn-outline-primary"><i
                                                                class="bi bi-eye"></i> Profile</a>
                                                        @can('edit users')
                                                            <a href="{{ route('student.edit', ['id' => $student->student->id]) }}"
                                                                role="button" class="btn btn-sm btn-outline-primary"><i
