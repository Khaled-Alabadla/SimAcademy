                        ...
                        <div class="row align-items-md-stretch mt-4">
                            ...
                            <div class="col">
                                <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                    ...
                                    <p class="text-end">with <i class="bi bi-lightning"></i> <a href=""
                                            style="text-decoration: none;">SimAcademy</a> <i class="bi bi-lightning"></i>.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-3">
                                    <div class="card-header bg-transparent d-flex justify-content-between"><span><i
                                                class="bi bi-megaphone me-2"></i> Notices</span></div>
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="flush-collapse{{ $notice->id }}"
                                                                ...
                                                                <div class="accordion-body overflow-auto">
                                                                    {!! \Mews\Purifier\Facades\Purifier::clean($notice->notice) !!}</div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @endisset
