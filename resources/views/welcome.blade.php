    ...
    <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <a href="https://sim-academy.vercel.app" class="text-gray-900 dark:text-white"
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                <h1 class="text-gray-900 dark:text-white"><img src="/favicon_io/android-chrome-512x512.png"
                ...
                <img class="ml-4" src="/bootstrap-5-1.svg" height="70" alt="Bootstrap 5">
            </div>
